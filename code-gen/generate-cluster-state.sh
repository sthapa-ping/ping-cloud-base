...
echo "Initial ROOT_VOLUME_SIZE: ${ROOT_VOLUME_SIZE}"
...
# Define the default size of the root volume for an instance as 40Gi.
export ROOT_VOLUME_SIZE=${ROOT_VOLUME_SIZE:-40Gi}
...
echo "Using ROOT_VOLUME_SIZE: ${ROOT_VOLUME_SIZE}"
